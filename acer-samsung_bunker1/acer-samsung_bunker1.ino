...
// NOTE: Originally used NeoPixels 1.1.6
...
#define STRIPLEDCOUNT   150       // Number of LEDs in the whole LED strip (useful for setting all LED black for example)
#define USEDLEDCOUNT   60       // Number of LEDs used for boblight
...
// Converts LED Id from screen capture software (Lightpack) to Strip LED id
int bobs[] = {  // 60 LEDs, 2 rows of 30 across top and bottom of screen
